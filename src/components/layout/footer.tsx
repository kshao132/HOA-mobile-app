...
const ITEMS = [
  {
    title: 'Contact',
    links: [
      { name: '+1 (925) 319-5758', href: 'tel:+19253195758' },
      { name: 'info@hoaalchemy.com', href: 'mailto:info@hoaalchemy.com' },
    ],
  },
  {
    title: 'Legal',
      ...
      <div className="container">
        <div className="flex flex-col items-start justify-between gap-6 md:flex-row md:gap-14">
          <div className="flex w-full flex-col divide-y md:w-auto md:flex-row md:items-center md:divide-x md:divide-y-0">
            ...
            <p className="pt-4 text-xl md:ps-4 md:pt-0">
              Download the HOA App on the <a href="https://apps.apple.com/us/app/id6447296089" className="underline" target="_blank">App Store</a> for Residents and Boards
              <br></br>
              Download the Alchemy App on the <a href="https://apps.apple.com/us/app/id6446015285" className="underline" target="_blank">App Store</a> for Vendors
            </p>
          </div>
        ...
        <div className="flex flex-col justify-between gap-6 md:flex-row">
          <p className="text-xl opacity-70">
            © Copyright {new Date().getFullYear()} HOA Alchemy LLC. All rights reserved.
          </p>
